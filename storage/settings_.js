      ...
      },
      {
        ...
        types: [
          //Types
          {
            ...
            children: [
              //
              { name: '2x server boosts', price: 40, rs: 35 },
              { name: '4x server boosts', price: 65, rs: 60 },
              { name: '6x server boosts', price: 100, rs: 95 },
              { name: '8x server boosts', price: 140, rs: 135 },
              { name: '14x server boosts', price: 190, rs: 185 },
        ...
        types: [
          {
            ...
            children: [
              ...
              { name: '200 robux (payout)', price: 75, rs: 75 },
              { name: '300 robux (payout)', price: 110, rs: 110 },
              { name: '400 robux (payout)', price: 145, rs: 145 },
              { name: '500 robux (payout)', price: 180, rs: 180 },
              { name: '600 robux (payout)', price: 215, rs: 215 },
              { name: '700 robux (payout)', price: 250, rs: 250 },
              { name: '800 robux (payout)', price: 285, rs: 285 },
              { name: '900 robux (payout)', price: 320, rs: 320 },
              { name: '1000 robux (payout)', price: 350, rs: 350 },
